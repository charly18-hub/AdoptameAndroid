package com.example.adoptame.presentation.Formulario
...
import com.example.adoptame.presentation.FragmentsFormatoAdopcion.FormularioFragment
...
class FormularioActivity : AppCompatActivity() {
    ...
    private fun getSpecie(){
        val sharedPreferences = applicationContext?.getSharedPreferences("PREFERENCE_NAME",
            MODE_PRIVATE
        )
